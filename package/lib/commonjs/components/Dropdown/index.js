...
const DropdownComponent = /*#__PURE__*/_react.default.forwardRef((props, currentRef) => {
      ...
      setTimeout(() => {
        if (refList && refList !== null && refList !== void 0 && refList.current) {
          ...
          if (index > -1 && index <= listData.length - 1) {
            ...
            refList === null || refList === void 0 || (_refList$current = refList.current) === null || _refList$current === void 0 || _refList$current.scrollToIndex({
              index: index,
              animated: false
            });
          }
  ...
  const _renderList = (0, _react.useCallback)(isTopPosition => {
    ...
    const _renderFixedTop = () => {
      if (renderFixedTop && typeof renderFixedTop === 'function') {
        return renderFixedTop();
      }
    };
    ...
    }, _renderFixedTop(), isInverted && _renderListHelper(), renderSearch(), !isInverted && _renderListHelper()));
  }, [_renderItem, accessibilityLabel, renderFixedTop, flatListProps, listData, inverted, renderSearch, scrollIndex, showsVerticalScrollIndicator, testID]);
